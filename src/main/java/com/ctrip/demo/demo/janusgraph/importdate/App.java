package com.ctrip.demo.demo.janusgraph.importdate;// Copyright 2017 JanusGraph Authors
//
...
public class App extends JanusGraphApp {
    ...
    public static void main(String[] args) {
        ...
        final App app = new App(fileName);
        app.runApp();
    }
}
